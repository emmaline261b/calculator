Feature: Algebraic Notation - evaluation
    ...
    Scenario Outline: Compound expressions
        ...
        Examples:
            | expression     | result        | comment                                 |
            | 1 + 2 + 3      | 6             | No ambiguity - left to right            |
            | 1 - 2 - 3      | -4            | No ambiguity - left to right            |
            | 2 * 1 * 3      | 6             | No ambiguity - left to right            |
            | 2 / 1 / 3      | 0             | No ambiguity - left to right            |
            | 1 - 2 + 3      | 2             | + and - have the same priority          |
            | 1 + 2 - 3      | 0             | + and - have the same priority          |
            | 2 / 1 * 3      | 6             | * and / have the same priority          |
            | 2 * 1 / 3      | 0             | * and / have the same priority          |
            | 2 * 2 + 2      | 6             | * has higher priority than +            |
            | 2 + 2 * 2      | 6             | * has higher priority than +            |
            | 2 / 2 + 2      | 3             | / has higher priority than +            |
            | 2 + 2 / 2      | 3             | / has higher priority than +            |
            | 2 * 2 - 2      | 2             | * has higher priority than -            |
            | 2 - 2 * 2      | -2            | * has higher priority than -            |
            | 2 / 2 - 2      | -1            | / has higher priority than -            |
            | 2 - 2 / 2      | 1             | / has higher priority than -            |

    Scenario Outline: Parentheses
        When I evaluate the following expression: "<expression>"
        Then I get the following result: "<result>"
        Examples:
            | expression     | result        | comment                                 |
            | 1 + ( 2 + 3 )  | 6             | + is associative (1)                    |
            | ( 1 + 2 ) + 3  | 6             | + is associative (2)                    |
            | 1 - ( 2 - 3 )  | 2             | - is not associative (1)                |
            | ( 1 - 2 ) - 3  | -4            | - is not associative (2)                |
            | 2 * ( 1 * 3 )  | 6             | * is associative (1)                    |
            | ( 2 * 1 ) * 3  | 6             | * is associative (2)                    |
            | 2 / ( 2 / 2 )  | 2             | / is not associative (1)                |
            | ( 2 / 2 ) / 2  | 0             | / is not associative (2)                |
            | 1 + ( 2 - 3 )  | 0             | Parentheses have the highest priority   |
            | 1 - ( 2 + 3 )  | -4            | Parentheses have the highest priority   |
            | 2 * ( 1 / 3 )  | 0             | Parentheses have the highest priority   |
            | 2 / ( 3 * 1 )  | 0             | Parentheses have the highest priority   |
            | 2 + ( 2 * 2 )  | 6             | Parentheses have the highest priority   |
            | 2 * ( 2 + 2 )  | 8             | Parentheses have the highest priority   |
            | ( 2 + 2 ) * 2  | 8             | Parentheses have the highest priority   |
